 ...
 */
final class Version20220105162733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT NOT NULL, corresponding_client_id INT DEFAULT NULL, content VARCHAR(5000) DEFAULT NULL, publication_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CFBDFA144DF89C0E ON note (corresponding_client_id)');
        $this->addSql('CREATE TABLE tache (id INT NOT NULL, corresponding_client_id INT DEFAULT NULL, content VARCHAR(1000) DEFAULT NULL, publication_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, titre VARCHAR(255) NOT NULL, etat VARCHAR(40) NOT NULL, PRIMARY KEY(id))');
